...
public class DepartmentDAOImpl implements DepartmentDAO {
	...
	public String addDepartment(Department department) {
		...
		int result = 0;
		String query = "insert into DEPARTMENT (id,organizationId,name) values(?,?,?)";
		try {
	...
	public String updateDepartment(Department department, long id) {
		...
		PreparedStatement preparedStatement = null;
		int result = 0;
		String query = "UPDATE DEPARTMENT departmentId=?, organizationId=?, name=? WHERE departmentId=" + id;
		try {
			 preparedStatement = connection.prepareStatement(query);
			 preparedStatement.setLong(1, department.getId());
			 preparedStatement.setLong(2, department.getOrganizationId());
	...
	public Optional<List<Employee>> getEmployees(long id)
	{
		...
		String query = "select * from EMPLOYEE order where departmentid=" + id;
		try {
			 preparedStatement = connection.prepareStatement(query);
