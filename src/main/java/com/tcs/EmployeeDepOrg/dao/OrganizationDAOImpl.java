...
public class OrganizationDAOImpl implements OrganizationDAO {
	...
	public String addOrganization(Organization organization) {
		...
		int result = 0;
		String query = "insert into ORGANIZATION (organizationid,name,address) values(?,?,?)";
		try {
	...
	public String updateOrganization(Organization organization, long id) {
		...
		PreparedStatement preparedStatement = null;
		int result = 0;
		String query = "UPDATE ORGANIZATION set organizationId=?, name=?, address=? WHERE organizationId=" + id;
		try {
			 preparedStatement = connection.prepareStatement(query);
			 preparedStatement.setLong(1, organization.getId());
			 preparedStatement.setString(2, organization.getName());
